(function(){
    ...
    var attrArray = ["healthcare providers", "primary care providers", "residents per PC provider", "physicians", "primary care physicians"];
    ...
    function joinData(ustates, csvData){
        ["healthcare providers", "primary care providers", "residents per PC provider", "physicians", "primary care physicians"];
